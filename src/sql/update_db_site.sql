...
(id_right, id_user)
VALUES 
("SHELTERS_MANAGEMENT", 5),
("SHELTERS_MANAGEMENT", 6),
("SHELTERS_MANAGEMENT", 7),
("SHELTERS_MANAGEMENT", 8),
("SHELTERS_MANAGEMENT", 9),
("SHELTERS_MANAGEMENT", 10),
("SHELTERS_MANAGEMENT", 11),
("SHELTERS_MANAGEMENT", 12),
("SHELTERS_MANAGEMENT", 13),
("SHELTERS_MANAGEMENT", 14),
("SHELTERS_MANAGEMENT", 15),
("SHELTERS_MANAGEMENT", 16),
("SHELTERS_MANAGEMENT", 17),
("SHELTERS_MANAGEMENT", 18),
("SHELTERS_MANAGEMENT", 19),
("SHELTERS_MANAGEMENT", 20),
("SHELTERS_MANAGEMENT", 21),
("SHELTERS_MANAGEMENT", 22),
("SHELTERS_MANAGEMENT", 23),
("SHELTERS_MANAGEMENT", 24),
("SHELTERS_MANAGEMENT", 25),
("SHELTERS_MANAGEMENT", 26),
("SHELTERS_MANAGEMENT", 27),
("SHELTERS_MANAGEMENT", 28),
("SHELTERS_MANAGEMENT", 29),
("SHELTERS_MANAGEMENT", 30),
("SHELTERS_MANAGEMENT", 31),
("SHELTERS_MANAGEMENT", 32),
("SHELTERS_MANAGEMENT", 33),
("SHELTERS_MANAGEMENT", 34),
("SHELTERS_MANAGEMENT", 35),
("SHELTERS_MANAGEMENT", 36),
("SHELTERS_MANAGEMENT", 37),
("SHELTERS_MANAGEMENT", 38),
("SHELTERS_MANAGEMENT", 39),
("SHELTERS_MANAGEMENT", 40);
